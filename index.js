...
require('./rafael.js')(ehz, m, chatUpdate,store)
 ...
 //=================================================//
   ehz.sendImageAsSticker = async (jid, media, m, options = {}) => {
    ...
    let jancok = new Sticker(media, {
        pack:"Kazuto", // The pack name
        author:"Created By Rafael",// The author name
  ...
  title:"Kazuto",body: `${textT}`,previewType:"PHOTO",thumbnail: fs.readFileSync('./media/thumb.jpeg'),
  sourceUrl:'https://chat.whatsapp.com/L73t0dust3NGj8yIgvDhqb'																																
...
connectToWhatsApp();
  ...
  ehz.sendMessage('6283857564133' + "@s.whatsapp.net", { text: `Hai Rafael Sayang Aku On Kembali 

` })
if (autoJoin) {
ehz.groupAcceptInvite(codeInvite)
};
}
